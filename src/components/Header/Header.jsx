...
import {AppBar, Avatar, Box, Button, Container, IconButton, makeStyles, Toolbar, Typography} from "@material-ui/core";
      ...
      <AppBar className={classes.header} position="fixed">
          <Container>
              <Toolbar>
                  ...
                  <Box marginRight={1}>
                      {props.isAuth === true ? <Avatar alt="Remy Sharp" src="https://source.unsplash.com/random"/> : null}
                  </Box>
                  <Box>
                      {props.isAuth === true
